...
matproxy.Add(
{
	...
	bind = function(self, mat, ent)
		...
		if IsValid(ent.ProxyentCritGlow) and ent.ProxyentCritGlow.Color then
...
matproxy.Add(
{
	...
	bind = function(self, mat, ent)
		...
		if !Matproxy_TF2CritGlow_UseModelGlowColor[mat:GetName()] and ent.ProxyentCritGlow and ent.ProxyentCritGlow.Color then
			mat:SetVector(self.ResultTo, ent.ProxyentCritGlow.Color)
		else
			mat:SetVector(self.ResultTo, Vector(1,1,1))
		end
